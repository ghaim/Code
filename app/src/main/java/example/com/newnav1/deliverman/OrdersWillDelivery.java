...
public class OrdersWillDelivery extends AppCompatActivity {
        ...
        rv.addOnItemTouchListener(
                new RecyclerItemClickListener(this, new RecyclerItemClickListener.OnItemClickListener() {
                    ...
                    public void onItemClick(View view, int position) {
                        ...
                        startActivity(new Intent(OrdersWillDelivery.this, DeliveryDetailsActivity.class).putExtra("order", ordersList.get(position)).putExtra("screen","delivering"));
